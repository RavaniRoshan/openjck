---
title: CrewAI
description: Using OpenJCK with CrewAI.
---
...
OpenJCK supports both synchronous and asynchronous CrewAI usage:

- **Synchronous**: Works out of the box with `@trace` and `@trace_tool` decorators
- **Asynchronous**: Use `@trace` and `@trace_tool` on async methods - OpenJCK automatically handles async functions
...
## How OpenJCK Integrates with CrewAI
When you trace CrewAI applications with OpenJCK:
